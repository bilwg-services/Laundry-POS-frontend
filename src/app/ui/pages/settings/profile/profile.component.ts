...
export class ProfileComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    // Ensure the file input reference is available after the view is initialized
    if (this.fileInput) {
      console.log('File input is available:', this.fileInput);
    }
  }
